<template>
  <div>
    ...
    <!-- message -->
    <div class="mt-10 h-auto mb-2">
      {{ selectedItem.description }}
    </div>
    <!--Attachments-->
    <div>
      <ul>
        <li class="flex items-center justify-between py-4  pr-20 text-sm leading-6" v-for="attachment in attachments">
          <div class="flex w-0 flex-1 items-center">
            ...
            <div class="ml-4 flex min-w-0 flex-1 gap-2">
              ...
              <span class="flex-shrink-0 text-gray-400">{{ attachment.size }}</span>
            </div>
          </div>
          <div class="ml-4 flex-shrink-0">
            <a :href="attachment.path" class="font-medium text-indigo-600 hover:text-indigo-500" target="_blank">        <button type="button"  data-te-ripple-init data-te-ripple-color="light"
